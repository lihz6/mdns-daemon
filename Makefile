...
COMPILE_FLAGS = -std=gnu11 -Wall -Wextra -g
...
release: export BUILD_PATH := out/release
release: export BIN_PATH := bin/release
debug: export BUILD_PATH := out/debug
...
SOURCES = $(shell find $(SRC_PATH) -name '*.c' -printf '%T@\t%p\n' | sort -k 1nr | cut -f2-)
